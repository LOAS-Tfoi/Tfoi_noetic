#ifndef __RECHARGE_CONTROLLER_CLASS_H_
#define __RECHARGE_CONTROLLER_CLASS_H_
...
#include "recharge_controller/DisRecharge.h"
#include "recharge_controller/PathIsVaild.h"
#include "recharge_controller/Recharge.h"
...
namespace recharge_controller_ns
{
  ...
  private:
    ...
    // 回充点坐标更新回调函数
    bool rechargeCallback(recharge_controller::Recharge::Request &req, recharge_controller::Recharge::Response &res);
    bool disRechargeCallback(recharge_controller::DisRecharge::Request &req, recharge_controller::DisRecharge::Response &res);
    ...
    //bms反馈
    // void ctrlFbCallback(const yhs_can_msgs::ctrl_fb::ConstPtr& ctrl_fb_msg);//dxs
    // void ioFbCallback(const yhs_can_msgs::io_fb::ConstPtr& io_fb_msg);//dxs
    // void bmsFlagFbCallback(const yhs_can_msgs::bms_flag_fb::ConstPtr& bms_flag_fb_msg);//dxs
    // void bmsFbCallback(const yhs_can_msgs::bms_fb::ConstPtr& bms_fb_msg);//dxs
